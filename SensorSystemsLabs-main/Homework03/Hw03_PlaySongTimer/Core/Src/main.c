...
void startNote(Note n) {
	...
	__HAL_TIM_SET_AUTORELOAD(&htim1, n.tone);
	__HAL_TIM_SET_COMPARE(&htim1, TIM_CHANNEL_2, n.tone/2);
	__HAL_TIM_SET_COUNTER(&htim1, 0);

	__HAL_TIM_SET_AUTORELOAD(&htim2, n.duration * TEMPO * 10);
